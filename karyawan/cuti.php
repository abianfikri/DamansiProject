    ...
    <div class="main-container d-flex">
        <div class="sidebar" id="side_nav">
            <div class="header-box px-2 pt-3 pb-4 ">
                ...
                <h5 class="text-center text-white mt-3"><?php echo $bagian ?></h5>
                <h4 class="text-center mt-3"><?php echo $nama ?></h4>
        ...
        <div class="content mb-3">
            ...
            <!-- Form Start -->
            <form action="cuti_action.php" method="post">
                                ...
                                <div class="col-md">
                                    <div class="mb-2">
                                        <label for="nama" class="form-label">Nama
                                            Lengkap</label>
                                        <input type="text" class="form-control" id="nama" readonly <?php echo "value = $nama" ?> />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md">
                                    <div class="form-floating">
                                        <textarea class="form-control" placeholder="Leave a comment here" name="alasan" id="floatingTextarea2" style="height: 100px"></textarea>
